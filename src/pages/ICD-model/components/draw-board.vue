  ...
  <div class="draw-wrap">
    <div class="draw-box">
      ...
      <div id="canvasDiv" class="right-draw-canvas">
        ...
        <canvas id="c" class="canvas-container" width="1170" height="727">请使用支持HTML5的浏览器</canvas>
      </div>
    </div>
    <!-- 图片添加预备项 -->
...
export default {
  ...
  methods: {
    ...
    _init_draw_board() {
      this.$data.__canvas = new fabric.Canvas("c", {
    ...
    _set_tool_box() {
      ...
      $("#toolsul").find("li").on("click", function() {
        // 设置样式
        $("#toolsul").find("li>i") && $("#toolsul").find("li>i").each(() => {
